            ...
            {step === 0 && (
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-3 cursor-pointer rounded-xl border-2 border-gray-100 flex items-center justify-center gap-3 font-bold text-gray-600 hover:border-indigo-200 transition-all active:scale-[0.98]">
