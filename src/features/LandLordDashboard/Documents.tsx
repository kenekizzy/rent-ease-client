...
// Map mime type / file extension to an icon + colour
...
const Documents = () => {
    ...
    // Fetch properties to derive propertyId
    ...
    // Fetch documents for the first property
    const {
        data: documents,
        isLoading,
        isError,
        ...
        queryFn: () => apiClient.get<DocumentRecord[]>(`/files/property/${propertyId}`),
        enabled: !!propertyId,
    })
    ...
    return (
        <>
            ...
            <Modal type="createDocument" title="Upload Document" description="Select a file to upload to this property.">
                {propertyId && (
                    <DocumentUploader
