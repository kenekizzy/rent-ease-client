...
import { Upload, MoreVertical, Download, FileText, FileArchive } from "lucide-react";

const documents = [
  { name: "Lease Agreement", type: "PDF", size: "2.4 MB", date: "Jan 1, 2024", icon: FileText, iconColor: "text-blue-500", iconBg: "bg-blue-50" },
  { name: "Move-in Inspection", type: "PDF", size: "1.8 MB", date: "Jan 5, 2024", icon: FileText, iconColor: "text-green-500", iconBg: "bg-green-50" },
  { name: "Property Photos", type: "ZIP", size: "12.5 MB", date: "Jan 3, 2024", icon: FileArchive, iconColor: "text-purple-500", iconBg: "bg-purple-50" },
];
          ...
          {documents.map((doc, i) => {
            ...
            return (
              <div key={i} className="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow">
                ...
                <p className="text-xs text-gray-400 mb-3">{doc.type} • {doc.size}</p>
